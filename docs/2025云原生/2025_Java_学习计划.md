...
- [2025 Java 学习计划](#2025-java-%E5%AD%A6%E4%B9%A0%E8%AE%A1%E5%88%92)
  ...
  - [第三阶段 后端 & 全栈 Sprint](#%E7%AC%AC%E4%B8%89%E9%98%B6%E6%AE%B5-%E5%90%8E%E7%AB%AF--%E5%85%A8%E6%A0%88-sprint)
    ...
    - [时间轴](#%E6%97%B6%E9%97%B4%E8%BD%B4)
      - [Week 7 - 准备与能力打底](#week-7---%E5%87%86%E5%A4%87%E4%B8%8E%E8%83%BD%E5%8A%9B%E6%89%93%E5%BA%95)

<!-- END doctoc generated TOC please keep comment here to allow auto update -->

# 2025 Java 学习计划

> **Note**: 本文档记录了 2025 年度的系统性学习路径模板。实际执行进度请参考项目 [VISION.md](../../VISION.md) 与 [LEARNING_PATH.md](../LEARNING_PATH.md)。
...
- **Java 后端工程师**与 **全栈工程师（React/TS + Java）**，**优先深圳外企**，同时关注本地优质团队。

#### 总目标（至 2025 年底）

- 在深圳完成**简历筛选→多轮面试→入职**的闭环准备与执行，确保材料和表达对齐“后端/全栈 + 云原生”的岗位期待。

#### 分目标

- **筛选过线**：中/英一页简历各一份（仅写工作经历、不写具体数值；将云原生与全栈要点自然融合到“最近工作经历”）。
- **面试表达**：形成可复用的结构化回答——45 秒英文电梯陈述、10–12 个高频问答要点、3–4 个 STAR 素材（中英均可讲）。
...
> 总节奏：每天三件事 = 算法 + 面试能力/知识 + 英语（学习即写文档，按需更新 `architecture.md / QBANK.md / elevator_pitch_en.md`）。
